...
How to publish a version of the frontend to GHCR.

A release publishes two artifacts and **deploys nothing**:

```text
ghcr.io/ic3software/vtafarm:<version>            container image
ghcr.io/ic3software/charts/vtafarm:<version>     Helm chart
```
